...
<head>
    ...
    <title>Register - Sistem Informasi Gereja</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Silakan buat akun jemaat untuk mulai menggunakan sistem laporan kegiatan ibadah.
                        </p>

                        <form id="formRegister" class="mb-3" action="proses_register" method="POST">
                            <div class="mb-3">
